	...
	<c:forEach var="post" items="${posts.content}">
		<div class="pt-2 grid-container">
                <div class="two">
                    ...
                    <div class="px-3 pt-3">
                        <h3 class="name"> Title : ${post.title}</h3>
                        <a href="/post/${post.id}" class="btn">상세보기...</a>
                    </div>
                    <div class="d-flex justify-content-start px-3 align-items-center"> <i class="mdi mdi-view-comfy task"></i> <span class="quote2 pl-2">user : ${post.user.username}</span> </div>
                    <div class="d-flex justify-content-between px-3 align-items-center pb-3">
                        <div class="d-flex justify-content-start align-items-center"> <i class="mdi mdi-calendar-clock date"></i> <span class="quote2 pl-2">Date: ${post.createDate}</span> </div>
